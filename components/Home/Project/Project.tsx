    ...
    <div className='pt-16 pb-16'>
        <div className='w-[80%] mx-auto'>
            ...
            <div className='grid grid-clos-1 lg:grid-cols-2 gap-10 items-center'>
                <div>
                    <h1 className='text-lg sm:text-xl md:text-2xl font-bold text-blue-700 dark:text-pink-500 uppercase'>Latest Works</h1>
                    <h1 className='text-xl sm:text-3xl md:text-4xl mt-1 font-bold'>Driving Change with Innovative Succesful Projects</h1>
                </div>
