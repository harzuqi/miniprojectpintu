    ...
    <div className='pt-16 pb-16'>
        ...
        {/* Section Heading */}
            <div className='grid grid-clos-1 lg:grid-cols-2 gap-10 items-center'>
                <div>
                    <h1 className='text-lg sm:text-xl md:text-2xl font-bold text-blue-700 dark:text-pink-500'>What we provide</h1>
                    <h1 className='text-xl sm:text-3xl md:text-4xl mt-1 font-bold'>Provide High Quality Software's Services for All Industry</h1>
                </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center mt-16'>
                ...
                <div data-aos='fade-right' data-aos-anchor-placement='top-center' data-aos-delay='300'>
                    <ServiceCard image="/images/s3.png" title="Cloud Computing and Hosting Service" />
                </div>
                <div data-aos='fade-right' data-aos-anchor-placement='top-center' data-aos-delay='400'>
                    <ServiceCard image="/images/s4.png" title="AI and Machine Learning Integration" />
                </div>
                <div data-aos='fade-right' data-aos-anchor-placement='top-center' data-aos-delay='500'>
                    <ServiceCard image="/images/s5.png" title="Android & iOS App Development" />
                </div>
                <div data-aos='fade-right' data-aos-anchor-placement='top-center' data-aos-delay='600'>
                    <ServiceCard image="/images/s6.png" title="3D Graphics & Vector Designing" />
                </div>
            </div>
        </div>
    </div>
