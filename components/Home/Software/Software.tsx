  ...
  return (
    <div className='pt-16 pb-16'>
        <div className='text-center'>
            {/* subheading */}
            <h1 className='uppercase text-lg sm:text-xl md:text-2xl font-bold text-blue-700 dark:text-pink-500'>Softwares</h1>
            {/* heading */}
        ...
        <div className='w-[80%] mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10'>
            ...
            <div data-aos='fade-up' data-aos-anchor-placement='top-center' data-aos-delay='200'>
                <SoftwareCard icon='/images/i3.png' title='Best '/>
            </div>
        </div>
    </div>
  )
